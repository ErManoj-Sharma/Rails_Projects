...
ActiveRecord::Schema.define(version: 2023_02_01_073649) do
  ...
  create_table "issue_assignments", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_issue_assignments_on_user_id"
  end
  ...
  create_table "project_issues", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["issue_id"], name: "index_project_issues_on_issue_id"
  ...
  add_foreign_key "issue_assignments", "users"
  add_foreign_key "project_issues", "issues"
